...
public class HOTPAlgorithm {
  ...
  String pass = "12345678901234567890";
  byte[] code = pass.getBytes();
 // HOTPAlgorithm.generateOTP(code, 1, 6, false, 1);
  //HOTPAlgorithm.generateOTP(code, 1, 6, false, 1);
  //for (int i = 0; i < 10; i++) {
  try {
  System.out.println(HOTPAlgorithm.generateOTP(code, 0, 6, false, 0));//030356
  //System.out.println(HOTPAlgorithm.generateOTP(code, 3, 6, false, 1));// 826128
  }
  catch (Exception e) {
